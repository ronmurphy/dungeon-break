...
export const ENEMY_DATA = {
    ...
    'female_twin': { name: "Malice", hp: 30, ac: 3, str: 3, xp: 60 },
    'male_twin': { name: "Anger", hp: 35, ac: 3, str: 3, xp: 60 },
...
export function getEnemyStats(filename) {
    ...
    if (lower.includes('sorcoress')) return { ...ENEMY_DATA['sorcoress'] };
    ...
    if (lower.includes('gremlin')) return { ...ENEMY_DATA['gremlinn'], name: "Gremlin", hp: 6, ac: 0 };
